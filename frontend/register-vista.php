...
<head>
    <meta charset="UTF-8">
    <title>Login / Register Artistik</title>
...
<div class="container-form">
        <div class="header">
            <div class="logo-title">
                <img src="image/logo_artistik.png" alt="">
                <h2>Artistik Fotografía</h2>
            </div>
            <div class="menu">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="form">
            <div class="welcome-form"><h1>Bienvenido</h1><h2>Artik-Soft</h2></div>
